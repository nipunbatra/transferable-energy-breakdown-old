...
for appliance in ['hvac']:
    ...
    for feature in FEATURE_LISTS:
        ...
        for austin_fraction in np.linspace(0.0,1.0,6):
            out[appliance][feature][austin_fraction] = {}
            for boulder_fraction in np.linspace(0.0,1.0,6):
                out[appliance][feature][austin_fraction][boulder_fraction] = {}
                for sd_fraction in np.linspace(0.0,1.0,6):
                    for k in range(1,9):
                        ...
                        out[appliance][feature][austin_fraction][boulder_fraction][sd_fraction] = compute_prediction(frac_path, appliance, feature, k)

...
def preprocess(df, dfc, appliance, matrix_max=None, matrix_min=None):
	if appliance == "hvac":
		start, end = 5, 11
...
def prepare_df_factorisation(appliance, year, train_regions, train_fraction_dict,
                             ...
                             matrix_max=None, matrix_min=None):
	df, dfc = create_df_main(appliance, year, train_regions, train_fraction_dict,
	                         test_region, test_home, feature_list, seed)

	X_matrix, X_normalised, matrix_max, matrix_min, appliance_cols, aggregate_cols = preprocess(df, dfc, appliance, matrix_max, matrix_min)

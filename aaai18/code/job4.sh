...
do
	...
	do
		...
		python graph_laplacian_parallel.py normal 2 False False Austin SanDiego $random_seed $train_percentage
		#python graph_laplacian_parallel.py transfer 2 True False Austin SanDiego $random_seed $train_percentage
		python graph_laplacian_parallel.py transfer 2 False False Austin SanDiego $random_seed $train_percentage
	done
done

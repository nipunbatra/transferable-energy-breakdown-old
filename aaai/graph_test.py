...
A_store = pickle.load(open(os.path.expanduser('~/git/scalable-nilm/aaai/predictions/case-{}-graph_{}_{}_As.pkl'.format(case, source, constant_use)), 'r'))
...
directory = os.path.expanduser('~/git/scalable-nilm/aaai/predictions/TF/{}/case-{}/{}/{}'.format(setting, case, static_use, constant_use))

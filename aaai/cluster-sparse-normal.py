			...
			for num_season_factors in range(1, 9):
				for random_seed in range(5):
					for train_percentage in range(10, 110, 10):
						...
						OFILE = "{}/{}-{}-{}-{}-{}-{}.out".format(SLURM_OUT, static_fac[0], lam, num_home_factors, num_season_factors, random_seed, train_percentage )
						EFILE = "{}/{}-{}-{}-{}-{}-{}.err".format(SLURM_OUT, static_fac[0], lam, num_home_factors, num_season_factors, random_seed, train_percentage )
						SLURM_SCRIPT = "{}-{}-{}-{}-{}-{}.pbs".format(static_fac, lam, num_home_factors, num_season_factors, random_seed, train_percentage)
						CMD = 'python sparse-normal.py {} {} {} {} {} {} {}'.format(source, static_fac, lam, num_home_factors, num_season_factors, random_seed, train_percentage)
						lines = []
						lines.append("#!/bin/sh\n")

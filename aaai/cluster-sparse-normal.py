	...
	for lam in [0]:
		...
		for random_seed in range(5):
			for train_percentage in range(10, 110, 10):
				...
				EFILE = "{}/{}-{}-{}-{}.err".format(SLURM_OUT, static_fac[0], lam, random_seed, train_percentage )
				SLURM_SCRIPT = "{}-{}-{}-{}.pbs".format(static_fac, lam, random_seed, train_percentage)
				CMD = 'python sparse-normal-cv.py {} {} {} {} {}'.format(source, static_fac, lam, random_seed, train_percentage)
				lines = []
				lines.append("#!/bin/sh\n")

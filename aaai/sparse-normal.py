...
source, static_fac, lam, num_home_factors, num_season_factors, random_seed, train_percentage = sys.argv[1:]
...
name = "{}-{}-{}-{}-{}-{}-{}".format(source, static_fac, lam, num_home_factors, num_season_factors, random_seed, train_percentage)

with open(os.path.expanduser('~/aaai2017/normal_{}/'.format(source) + name + '.pkl'), 'wb') as f:

...
for random_seed in range(5):
	for train_percentage in range(10, 100, 20):
		OFILE = "{}/normal-{}-{}.out".format(SLURM_OUT, random_seed, train_percentage )
		EFILE = "{}/normal-{}-{}.err".format(SLURM_OUT, random_seed, train_percentage )
		SLURM_SCRIPT = "{}/normal-{}-{}.pbs".format('pbs_files', random_seed, train_percentage)
		CMD = 'python graph_laplacian_normal_cv.py {} {}'.format(random_seed, train_percentage)
		lines = []
		lines.append("#!/bin/sh\n")
